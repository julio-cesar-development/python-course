...
rabbitmqadmin declare --vhost=/ queue name=dead_letter auto_delete=false durable=true arguments='{"x-message-ttl": 60000, "x-dead-letter-exchange":"event_queue_exchange","x-dead-letter-routing-key":""}'
